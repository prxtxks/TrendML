...
![TrendML Dashboard](./readme-images/trendML.png)
...
![TrendML Dashboard](./readme-images/dashboard.png)
...
![Shopify Store Connection](./readme-images/store-connection.png)  

> 3. **Add TrendML Widget**: Display AI-powered recommendations on homepage, collections, and product pages.

![Widget on Storefront](./readme-images/widget.png)
...
![Recommender Settings](./readme-images/recommender-settings.png)
...
![AI Recommendations in Action](./readme-images/sample-store.png)
